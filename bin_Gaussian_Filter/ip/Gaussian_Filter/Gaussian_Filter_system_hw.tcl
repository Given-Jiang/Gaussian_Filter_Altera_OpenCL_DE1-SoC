...
set_module_property NAME Gaussian_Filter_system
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property GROUP Accelerators
set_module_property DISPLAY_NAME Gaussian_Filter_system
set_module_property TOP_LEVEL_HDL_FILE Gaussian_Filter_system.v
set_module_property TOP_LEVEL_HDL_MODULE Gaussian_Filter_system
...
### SLAVE interface avs_Gaussian_cra
add_interface avs_Gaussian_cra avalon end
set_interface_property avs_Gaussian_cra addressAlignment DYNAMIC
set_interface_property avs_Gaussian_cra burstOnBurstBoundariesOnly false
set_interface_property avs_Gaussian_cra explicitAddressSpan 0
set_interface_property avs_Gaussian_cra holdTime 0
set_interface_property avs_Gaussian_cra isMemoryDevice false
set_interface_property avs_Gaussian_cra isNonVolatileStorage false
set_interface_property avs_Gaussian_cra linewrapBursts false
set_interface_property avs_Gaussian_cra maximumPendingReadTransactions 1
set_interface_property avs_Gaussian_cra printableDevice false
set_interface_property avs_Gaussian_cra readLatency 0
set_interface_property avs_Gaussian_cra readWaitTime 1
set_interface_property avs_Gaussian_cra setupTime 0
set_interface_property avs_Gaussian_cra timingUnits Cycles
set_interface_property avs_Gaussian_cra writeWaitTime 0
set_interface_property avs_Gaussian_cra ASSOCIATED_CLOCK clock_reset
set_interface_property avs_Gaussian_cra ENABLED true
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_read read Input 1
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_write write Input 1
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_address address Input 4
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_writedata writedata Input 64
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_byteenable byteenable Input 8
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_waitrequest waitrequest Output 1
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_readdata readdata Output 64
add_interface_port avs_Gaussian_cra avs_Gaussian_cra_readdatavalid readdatavalid Output 1
...
add_file Gaussian_Filter.v {SYNTHESIS SIMULATION}
...
add_file acl_fp_sitofp.v {SYNTHESIS SIMULATION}
